...
## Project Structure
    ...
    ├── lively_waterfall_de_60647  # Django project configurations
...
1. Clone this repo and `cd lively_waterfall_de_60647`
...
2. Clone this repo and `cd lively_waterfall_de_60647`
